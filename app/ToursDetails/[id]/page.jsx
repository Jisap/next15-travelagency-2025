...
const page = () => {
  ...
  return (
    ...
    >
      ...
      <motion.div
        className="tour-details-container w-full flex flex-col lg:flex-row justify-between lg:items-stretch px-[2%] sm:px-[8%] lg:px-[12%] py-[50px] lg:py-[90px] gap-5 relative"
        variants={containerVariants}
        initial="hidden"
        animate="visible"
      >
        <div className="xl:w-[70%] lg:w-[60%] w-full relative flex flex-col gap-4">
          <motion.div variants={itemVariants} className="relative w-full h-[400px] rounded-xl overflow-hidden">
            <Image
              src={tour.mainImage}
              alt={tour.title}
              fill
          ...
          <motion.div variants={itemVariants} className="tour-details-content">
            ...
            <motion.form variants={itemVariants} className="contact-form w-full flex flex-col gap-5">
              {/* Name and Email Row */}
              <div className="w-full flex flex-col lg:flex-row gap-5">
                <div className="flex flex-col w-full lg:w-1/2">
                  <label className="pb-1 text-md font-[500]">Tu Nombre:</label>
                  <input
                    type="text"
                    placeholder="Name: "
                ...
                <div className="flex flex-col w-full lg:w-1/2">
                  <label className="pb-1 text-md font-[500]">Tu Email:</label>
                  <input
                    type="email"
              ...
              <div className="flex flex-col w-full">
                <label className="pb-1 text-md font-[500]">Tu Comentario:</label>
                <textarea
                  placeholder="Message: "
        ...
        <motion.div variants={itemVariants} className="xl:w-[30%] lg:w-[40%] w-full">
